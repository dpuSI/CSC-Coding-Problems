 ...
 *  is a common ancestor x along with a shortest path from v to x and a shortest
 *  path from w to x. The shortest ancestral path is the ancestral path whose
 *  total length is minimized. Warmup: Find a DAG where the shortest ancestral
 *  path goes to a common ancestor x that is not an LCA. Hint: Run BFS twice,
 *  once from v and once from w. 
 ******************************************************************************/
